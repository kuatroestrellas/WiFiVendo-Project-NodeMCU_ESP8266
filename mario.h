...
const int SensorD8Buzzer = 15;   // Buzzer Pin
...
delay (1000); 
tone(SensorD8Buzzer, LOW, 500) ; //RE note ...
delay (1000); 
tone(SensorD8Buzzer, HIGH, 1000) ; //MI note ...
delay (1000); 
tone(SensorD8Buzzer, LOW, 500) ; //FA note ...
delay (1000); 
tone(SensorD8Buzzer, HIGH, 2000) ; //FA note ...
delay (1000); 
...
void DropCoinBuzz() {
  tone( SensorD8Buzzer, HIGH, 500);
  delay(1000);
  tone( SensorD8Buzzer, LOW, 200);
  delay(1000);
  tone( SensorD8Buzzer, HIGH, 1000);
  delay(1000);
  tone( SensorD8Buzzer, LOW, 500);
  delay(1000);
  noTone(SensorD8Buzzer);
}

//Mario main theme melody TOP
int melody[] = {
...
void sing(int s){      
   ...
   if(song==2){
     ...
     for (int thisNote = 0; thisNote < size; thisNote++) {
       ...
       buzz(SensorD8Buzzer, underworld_melody[thisNote],noteDuration);
       ...
       buzz(SensorD8Buzzer, 0,noteDuration);
     ...
     for (int thisNote = 0; thisNote < size; thisNote++) {
       ...
       buzz(SensorD8Buzzer, melody[thisNote],noteDuration);
